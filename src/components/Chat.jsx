...
import { selectChannelId,selectChannelName } from "../redux/channelSlice";
            ...
            <header className="flex items-center justify-between space-x-5 border-b border-gray-800 p-4 mt-1">
                ...
                <div className="flex space-x-3">
                    ...
                    <div className="flex bg-[#202225] text-xs p-1 rounded-md">
                        <input type="text" placeholder="Search" className="bg-[#202225] focus:outline-none text-white pl-1 placeholder-[#72767d]"/>
           ...
           {/* Message Input */}
            <div className="flex items-center p-2.5 bg-[#40444b] mx-5 mb-7 rounded-lg">
              ...
              <form className="flex-grow">
                  <input type="text" placeholder="Message among-us-lfg" ref={inputRef} className="bg-transparent focus:outline-none text-[#dcddde] w-full placeholder-[#72767d] text-sm"/>
